...
export default function FrecuentQuestions(){
  ...
  return(
    <div className={styles.main}>
      ...
      <Categories categories={categories} activeCategory={activeCategory} onCategoryClick={handleCategoryClick}/>
      <Questions questions={questions} activeCategory={activeCategory}/>
    </div>
  )
}
