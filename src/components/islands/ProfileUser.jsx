export default function ProfileUser(){
  return(
    ...
    <div className="bg-white rounded-lg p-4 shadow-md">
      <h2 className="text-2xl text-slate-800 font-medium mb-4">Mi Cuenta</h2>
      <ul className="text-blue-600">
        <a href="/modifyAccount">
          <li className="py-1 hover:text-blue-800 block max-w-max">Editar la información de la cuenta</li>
        </a>
        <a href="/changePassword">
          <li className="py-1  hover:text-blue-800 block max-w-max">Cambiar tu contraseña</li>
        </a>
        <a href="/wish-list">
    ...
    <div className="bg-white rounded-lg p-4 shadow-md">
      ...
      <ul className="text-blue-700">
        ...
        <a href="/cart">
          <li className="py-1 hover:text-blue-800 block max-w-max">Ver carrito de compras</li>
        </a>
      </ul>
    </div>
    <div className="bg-white rounded-lg p-4 shadow-md">
      <h2 className="text-2xl text-slate-800 font-medium mb-4">Contáctanos</h2>
      <ul>
        ...
        <li className="py-1  hover:text-pink-600 block max-w-max">
          <a title="Instagram" href="https://www.instagram.com/ganaderiaelinfierno/" target="_blank">
