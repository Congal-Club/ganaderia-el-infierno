      ...
      {!isAccepted && (
        <section className='fixed transition z-50 top-[15%] left-[30%] w-[50%] rounded-lg border bg-white text-card-foreground shadow-2xl max-w-lg' data-v0-t='card'>
          ...
          <main className='p-6 pt-4 space-y-4'>
            <article className='flex items-start justify-between space-y-2'>
              <div>
          ...
          <footer className='flex items-center p-6'>
            <button
              className='inline-flex items-center justify-center h-10 px-4 py-2 ml-auto text-sm font-medium transition-colors rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90'
              type='submit'
